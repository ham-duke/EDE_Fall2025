...
ggplot(data=data.frame(x=0,y=0))+
  ...
  geom_text(
    ...
    #parse = TRUE ## these two lines of code are for newer tidyverse 
    )
...
#Plot howmonth()#Plot how many Lake observations occur each month
#month on the x vs frequency on the y 
...
plot2 <- PeterPaul.chem.nutrients %>% 
  ...
  labs(title = "Temp by date across depths",
       x = "Date in years",
       y = "Temperature",
       color = "Depth")
